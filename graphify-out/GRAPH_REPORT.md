...
## Corpus Check
- 244 files · ~78,353 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 770 nodes · 1332 edges · 76 communities (57 shown, 19 thin omitted)
...
Cohesion: 0.08
Nodes (44): registerSchema, registerUser(), resendCodeSchema, resendVerificationCodeAction(), verifyEmailAction(), verifyEmailSchema, POST(), getVerificationEmailHtml() (+36 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (19): fontMono, fontSans, fontSerif, metadata, AuthHeader(), AuthContext, AuthContextValue, AuthProvider() (+11 more)
...
Cohesion: 0.10
Nodes (24): Admin Workflow, Cashier Workflow, Customer Workflow, BentaHub Developer Manual, Email Verification Codes Table Schema, Feature-Sliced Design Guidelines, FSD Structural Directory Mapping, JWT & Registration Verification Flow (+16 more)

### Community 6 - "Community 6"
Cohesion: 0.20
Nodes (16): GET(), getUserIdFromToken(), DELETE(), getUserIdFromToken(), PUT(), extractToken(), verifyToken(), getUserIdFromToken() (+8 more)
...
Cohesion: 0.17
Nodes (10): InventoryFlowTrend(), KPICard(), KPICardProps, ReservationFilters(), SalesChart(), SalesChartProps, BranchOption, SalesFilters() (+2 more)
...
Cohesion: 0.18
Nodes (11): Development Commands, Contributing FSD Guidelines, Pull Request Quality Checklist, Contributing Local Setup, Code Verification & Style Gates, FSD Folder Structure, FSD Import Rules Details, FSD Isolation Principle Details (+3 more)
...
## Knowledge Gaps
- **214 isolated node(s):** `eslintConfig`, `config`, `pool`, `pool`, `pool` (+209 more)
...
- **Why does `AuthHeader()` connect `Community 1` to `Community 4`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
