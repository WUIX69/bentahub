...
export const products: Product[] = [
  ...
  },
  {
    id: "prod-003",
    sku: "HYG-889",
    name: "Moisturizing Soap (135g)",
    price: 48.0,
    category: "Household",
    stock: 5,
    reorderLevel: 10,
    image: "https://images.unsplash.com/photo-1607006342411-92fc98e72242?w=400&auto=format&fit=crop&q=80",
    unit: "pcs",
  },
  {
    id: "prod-004",
    sku: "BAK-112",
    name: "Classic White Bread (600g)",
    price: 65.0,
    category: "Bakery",
    stock: 0,
    reorderLevel: 15,
  ...
  },
  {
    id: "prod-009",
    sku: "PHR-601",
    name: "Paracetamol Tablets (500mg x 20)",
    price: 42.0,
    category: "Pharmacy",
    stock: 89,
    reorderLevel: 20,
...
/** Helper: get stock status from product */
