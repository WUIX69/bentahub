  ...
  return (
    <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-4 border-t border-border flex justify-between items-center bg-muted/5">
        <p className="text-xs text-muted-foreground">Showing 2 of 18 pending orders</p>
        <div className="flex items-center gap-1.5">
          ...
          <button className="w-9 h-9 flex items-center justify-center border border-border rounded text-muted-foreground hover:bg-muted transition-colors">
