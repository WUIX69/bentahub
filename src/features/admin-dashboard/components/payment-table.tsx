    ...
    <section className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
      <div className="px-6 py-3 bg-muted/20 border-b border-border flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button className="bg-muted hover:bg-muted/80 text-foreground px-4 py-2 rounded-lg text-xs font-bold flex items-center gap-2 shadow-sm transition-all">
            <SlidersHorizontal className="h-[18px] w-[18px]" />
            Filter
          </button>
          <button className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 rounded-lg text-xs font-bold flex items-center gap-2 shadow-sm transition-all">
